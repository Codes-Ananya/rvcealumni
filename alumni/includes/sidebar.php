<nav id="sidebar">
            ...
            <div class="user_profle_side">
                ...
                ?>
                        ...
                        <div class="user_info">
                            ...
                            <p><span class="online_animation"></span> <?php echo $row->Emailid; ?></p>
                        </div>
                <?php
                        $cnt = $cnt + 1;
                    }
    ...
    <div class="sidebar_blog_2">
        ...
        <ul class="list-unstyled components">
            ...
            <!-- New "View Alumni" Link -->
            <li><a href="view-alumni.php"><i class="fa fa-users green_color"></i> <span>View Alumni</span></a></li>
            <!-- New "View Discussion" Link -->
            <li><a href="view-discussion.php"><i class="fa fa-users green_color"></i> <span>Discussions</span></a></li>
